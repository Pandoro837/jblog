...
public class BlogController {
	...
	public String main(Model model, @PathVariable("id") String id) {
		...
		//카테고리 리스트 호출
		List<CateVo> cateList = blogService.getCate(id);
	...
	public String updateBasic(@ModelAttribute BlogVo blogUpdate, @RequestParam(value = "file", required = false) MultipartFile file) {
