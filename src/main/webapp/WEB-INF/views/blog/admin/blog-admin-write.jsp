	...
	<div id="wrap">
		...
		<div id="content">
			...
			<ul id="admin-menu" class="clearfix">
				...
				<li class="tabbtn selected"><a href="${pageContext.request.contextPath }/${blogInfo.id}/admin/writeForm">글작성</a></li>
			</ul>
			<!-- admin-menu -->

			<div id="admin-content">
				<form action="${pageContext.request.contextPath}/${blogInfo.id}/admin/write" method="post">
